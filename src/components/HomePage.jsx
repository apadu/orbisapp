export default function HomePage({ onEnter, onSelectMode }) {
  const MODES = [
    ...
    { section: 'Name' },
    { id: 'name-all',       icon: '🌍', label: 'All Countries',     desc: 'Name every country in the world against the clock' },
    { id: 'name-all-caps',  icon: '🏙️', label: 'All Capitals',      desc: 'Name every capital city you know' },
    { id: 'seas',           icon: '🌊', label: 'Seas',              desc: 'Identify oceans and seas on the globe' },
    { section: 'Quiz' },
    { id: 'capital',        icon: '🏛️', label: 'Capitals',          desc: 'Match countries to their capitals' },
